...
class Utils
{
  ...
  public static function decimal_br($p_decimalUS, $p_precision = 0)
  {
      ...
      public static function decimal_us($p_decimalBR)
      {
        if ($p_decimalBR) {
      ...
      public static function datetime_br($date_us = null)
      {
        if (empty($date_us)) {
      ...
      public static function datetime_us($date_br = null)
      {
        if (empty($date_br)) {
      ...
      public static function date_br($date_us = null)
      {
        if (empty($date_us)) {
          $date_us = date('Y-m-d');
        }
      ...
      public static function date_us($date_br = null)
      {
        if (empty($date_br)) {
          $date_br = date('d/m/Y');
        }
      ...
      public static function get_attr($p_array, $p_key, $p_default = null)
      {
        if (!is_array($p_array)) {
          return $p_default;
        }
     ...
     */
    public static function curl_post_async_config($time_limit = 0)
    {
    ...
    public static function urlparam_encode($p_array)
    {
      $params = "";
      if (!is_array($p_array)) {
    ...
    public static function urlparam_decode($p_http_query_string)
    {
    ...
    public static function remove_acents($texto)
    {
    ...
    public static function number_only($p_numero_str)
    {
      return preg_replace("/[^0-9]/", "", $p_numero_str);
    }

    public static function segments_until($segment_number) {
      $CI= &get_instance();
